...
export function ServicesSection() {
  return (
    <section className="py-8 sm:py-12 md:py-16 border-t border-gray-200 dark:border-zinc-900 bg-white dark:bg-black transition-colors duration-300">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
              <AnimatedSection animation="fadeUp" delay={300}>
                <div className="border border-gray-200 dark:border-zinc-800 rounded-lg p-4 sm:p-6 bg-gray-50 dark:bg-black hover:bg-gray-100 dark:hover:bg-zinc-900 transition-colors duration-300">
