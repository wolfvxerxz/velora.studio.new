      ...
      <div className="mx-auto px-4 flex justify-center">
        <div style={{ maxWidth: "640px" }} className="w-full">
          <AnimatedSection animation="fadeUp">
            <h1 className="text-3xl font-normal mb-4 leading-tight text-black">
              We design & build websites people actually want to use
            </h1>
          </AnimatedSection>

          <AnimatedSection animation="fadeUp" delay={100}>
            <h2 className="text-2xl font-normal mb-6 leading-relaxed text-gray-800">
          ...
          <AnimatedSection animation="fadeUp" delay={300}>
            <div className="flex flex-wrap gap-3 mb-8">
              ...
              <Link
                href="#work"
                className="px-6 py-3 rounded-full bg-gray-100 text-black text-base hover:bg-gray-200 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
              >
                View Work
              </Link>
            </div>
