...
export default function HomeClient({ workItems }: HomeClientProps) {
  ...
  const divider = <hr className="border-0 border-t border-white/[0.07] flex-shrink-0" />

  const scheduleButtonClass = "rounded-full border border-white/20 px-5 py-2 text-[13px] font-normal text-white/70 hover:border-white/40 hover:text-white hover:bg-white/[0.05] transition-all duration-200 inline-flex items-center gap-2"
  const scheduleBadge = (
    <kbd className="inline-flex items-center gap-0.5 rounded border border-white/20 bg-white/[0.05] px-1.5 py-0.5 font-sans text-[10px] font-medium text-white/50">
      ...
      >
        <div className="flex flex-col flex-1 px-5 py-5 gap-4 md:max-w-[420px] md:w-[420px]">
          ...
          <header className="flex items-center justify-between flex-shrink-0">
            ...
            <nav
              ref={navRef}
              className="relative flex gap-0.5 rounded-full bg-white/[0.06] p-1"
            >
              <span
                className="absolute top-1 bottom-1 rounded-full bg-white/[0.12] shadow-none transition-all duration-200 ease-out"
          ...
          {sidebarView === "index" && (
            <>
              <section className="flex-shrink-0">
                <h1 className="text-[19px] font-normal text-white leading-[1.3] tracking-[-0.01em] mb-2">
                  Design partner for founders building in AI, web3, and startups that move fast.
                </h1>
                <p className="text-[14px] font-normal text-white/70 leading-[1.45] tracking-tight">
              ...
              <section className="flex-shrink-0">
                <p className="text-[13px] font-normal text-white/45 mb-2 tracking-tight">Past clients include</p>
...
href="https://www.paypal.com/webapps/billing/plans/subscribe?plan_id=P-46U604671L576204CNC5DRPI"
                ...
                <div className="grid grid-cols-2 gap-x-3 gap-y-2">
                  {[
                    ...
                    <div key={label} className="service-item flex items-center gap-2 cursor-default">
                      ...
                      <span className="text-[13px] font-normal text-white/60 tracking-tight">{label}</span>
                    </div>
                  ))}
                </div>
              </section>
          ...
          {sidebarView === "about" && (
            <>
              <section className="flex-shrink-0 flex flex-col min-h-0">
                <h1 className="text-[19px] font-normal text-white leading-[1.3] tracking-[-0.01em] mb-3">
                  What clients say
                </h1>
          ...
          {sidebarView === "pricing" && (
            <>
              <section className="flex-shrink-0 flex flex-col gap-3">
                <div>
                  <h1 className="text-[19px] font-normal text-white leading-[1.3] tracking-[-0.01em]">Pricing</h1>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group flex flex-col rounded-2xl border border-black/[0.08] bg-black/[0.02] p-3.5 transition-all duration-200 hover:bg-black/[0.05] hover:border-white/15"
                    >
          ...
          <section className="flex items-center gap-3 flex-shrink-0 mt-auto pt-2">
            <a href="https://x.com/veloraxstudio" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors" aria-label="X (Twitter)">
              <svg className="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="https://www.linkedin.com/company/velorastudio/" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors" aria-label="LinkedIn">
              <svg className="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <a href="https://wa.me/message/CRWTXVTJ2LCJO1" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors" aria-label="WhatsApp">
              <svg className="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
            ...
            <a href="https://t.me/vukkm" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-white transition-colors" aria-label="Telegram">
              <svg className="w-[22px] h-[22px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
