...
export default function HomeClient({ workItems }: HomeClientProps) {
  ...
  const scheduleButtonClass = "rounded-full border border-black/20 px-5 py-2 text-[13px] font-normal text-black/80 hover:border-black/40 hover:text-black hover:bg-black/[0.03] transition-all duration-200 inline-flex items-center gap-2"
  const scheduleBadge = (
