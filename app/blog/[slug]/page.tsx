          ...
          <AnimatedSection animation="fadeUp">
            ...
            <article 
              className="prose dark:prose-invert max-w-none prose-lg
                ...
                prose-p:text-gray-600 dark:prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-[18px]
                prose-a:text-blue-600 dark:prose-a:text-blue-400 prose-a:no-underline hover:prose-a:underline
                prose-strong:text-black dark:prose-strong:text-white
                prose-ul:my-8 prose-ol:my-8
                prose-li:my-3 prose-li:text-gray-600 dark:prose-li:text-gray-300 prose-li:text-[18px]
                prose-blockquote:border-l-4 prose-blockquote:border-gray-300 dark:prose-blockquote:border-gray-600
                prose-blockquote:pl-6 prose-blockquote:italic prose-blockquote:text-[18px]
